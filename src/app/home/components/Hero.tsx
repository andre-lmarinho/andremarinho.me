...
export const Hero = () => {
  return (
    <section id="hero" className="flex min-h-[40dvh] items-center justify-between gap-8">
      <div className="space-y-5 sm:max-w-lg">
        ...
        <p>
          ...
          currently at <TextLink href={workPlaces[0].website}>{workPlaces[0].label}</TextLink>.
        </p>
      </div>
      <Image
        alt="André Marinho"
