  ...
  <section id="about" className="mt-6">
    <div className="mb-6 space-y-5">
      ...
      <p>
        ...
        based in Salvador 🇧🇷, that loves to code and build products with a delightful user experience.
      </p>

      <p>
        Currently working at <TextLink href={workPlaces[0].website}>{workPlaces[0].name}</TextLink> as a Front
        End Engineer 💻.
      </p>

      <p>
        I love working in between product, engineering and developer experience. Some things that make me
        excited are TypeScript, Open Source, CI & CD systems, simplicity, automating things and building
        meaningful user-centric products.
      </p>

      <p>
        I was born and raised in salvador next to the beach and I&apos;m studying Computer Science at{" "}
        <TextLink href="https://github.com/ossu/computer-science">OSSU</TextLink> with some Harvard&apos;s
        courses like{" "}
        <TextLink href="https://certificates.cs50.io/d7d5d5d9-8e76-4b4d-b324-9ed0fee6f9f5.pdf">CS50</TextLink>{" "}
      ...
      <p>
        ...
        <TextLink href="https://travel-planner-orpin.vercel.app/">exploring new places</TextLink> with my
        family.
      </p>
    </div>
