...
export default function Stacks() {
  return (
    <section id="stacks" className="py-20 bg-white dark:bg-gray-900 transition-colors duration-500">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
            Tecnologias e ferramentas que domino e utilizo nos meus projetos
          </p>
        </div>
